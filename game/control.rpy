...
label control3:
    ...
    scene darkforest
    "[d] moves away from [p]. [p] sits on the ground. He avoids looking at [d] while clumsily wipes his lips."
    scene sit_straight_repeat
    show m
    show m_m
    p "..."
    ...
    hide m_m_open_speak
    show m_m_normal
    d "You shouldn't ask for that after pushing me away."
    scene darkforest
    show m_tired
    show m_cockdown
    show m_shame
    ...
    scene sit_straight_up_repeat with dissolve
    show m_tired
    show m_cockdown
    show m_shame
    show m_m_normal
    ...
    show m_shame
    show m_m_normal
    "[p] looks like an empty shell." 
    "3 feets. What a joke. He cannot even get his own food and water within that range. [d] was just playing around with him." 
    scene sit_straight_repeat
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    "[p] hugs his knees and tucks his head between them, making him as small as possible."
    scene sit_sad_repeat
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    "It was very stupid of him. There is no way [d] lets him go or moving too freely. He will rotten here till the day he dies as [d]'s sex relief toy. He will never become a real human again"
    scene sit_sad_repeat
    show m
    show m_cockdown
    show m_shame
...
label alteration:
    ...
    scene alterNoFin
    p "ARGHHH...Ahhhh...."
    "He brutally shoves his cock all the way in."
    d "How many times had this cock violate your inside. What do you mean it won't fit in?"
    p "Aaaa...Aaaaaa....AGH....haaa..."
    d "It seems like I go too easy on you. We need to go all over the training again. Don't you think so?"
    p "Ahhh...Uhmm...ahhhh...."
    d "Don't you think so?"
    p "Aaa...Y-yes...ahhh...yes...."
    "[d] smirks."
    p "[d]...[d]...ngh...p-please stop...Aaaa...aaahh..Too deep...Argh!"
    p "Aaaa...."
    d "Too deep huh?"
    scene alterNoFinDeep
    p "AAAA....Aaaaa..."
    d "You sucks my cock quite well. It feels good inside you. So warm and tight."
    p "P-please stop...Aaaaa..."
    p "P-Please [d]...I beg you..."
    scene alterNoFinFast
    p "AAAAAAAAAAAAA!!!"
    p "AAAaaaa....Aaaaaahhhh...."
    p "Aaaaa....P-please [d]...ngh..."
    scene alterNoFinFaster with hpunch
    p "AAAAAAAA....AAAAAAAAA..."
    p "Aaaaahhhh....T-Too fast...C-an't keep u....aaaaaa..."
    ...
    p "*sniff *sniff..."
    d "You sure have a lot of tricks huh?"
    p "Mghhh...Mnnnn...h...*sniff..."
    scene alterTongue
    p "!"
    p "Mgh...N..."
    "[d] wraps [p]'s tongue around his."
    d "Make sure you such everything comes into your mouth"
    p "Uhhh...Mnnn...."
    d "Will you do it for your master?"
    p "Mgh...nhh...y-yes...s-sir....ngh...m..."
    d "Attaboy."
    p "..."
    scene alterKiss
    p "Mgh...N...."
    ...
    "But for some reasons, he had never felt as humiliated as he is now."
    "It like he had completely submit to [d], both body and soul."
    p "Mn....h..."
    scene alterNoFin with hpunch
    p "Ahhhh....aaaaa....N-No..."
    d "Didn't expect this huh? You thought that is it? I haven't cum you see."
    scene alterNoFinFast
    p "Aaaaaa....A.....hhh...."
    p "Aaaa...Mgh...aa...aaaaaa"
    scene alterNoFinFaster
    p "N-No...Ahhhhhh....AGGGGGGGG..."
    p "AAAGHHHHH...Aaaaa...aaaaaaaaaaaaaaaaaaaa..."
    scene alterOne with vpunch
    p "Ugh...ahhhh...aaaaaa...."
    "[p] cums as [d] penetrates into his head, then his brain."
    p "Ahhh....A....W-what are you doing [d]? Mgh..."
    "[p] feels hurt and dizzy, as if he cannot control his body anymore. He cums everytimes [d] thrusts his fingers inside his brain."
    scene alterTwo with hpunch
    p "Aaaaa...A....."
    "[d] penetrates deep inside [p]'s brain."
    p "P-Please stop [d]. It hurts."
    "Feeling his blood flows different than normal, [p] freaks out."
    p "W-Wha-...Ugh....Aaaaa...."
    d "What am I doing huh? I'm modifying you."
    p "!"
    p "A.....AAAAAAAAA......N-no......NOOOOOOOOOOOO!!!!!!"
    "[p] pushes [d]'s hand away but it was useless. He had no more strength."
    p "Aaa...Ngh....aaaa...P-Please stop [d]...Please don't do this to me....ngh..."
    scene alterTwoTongue
    p "Um....uhm...."
    d "Calm down. I'm helping you."
    "[d] wraps his tongue around [p]'s tongue."
    p "N-no...Please...Turn me back...Turn me back..."
...
label goodend:
    ...
    p "Ahh...hh..."
    d "It still hard."
    "[d] was going to jerk [p] off again, but [p] grasps his hand."
    scene temple
    show m
    show m_cockdown
    show m_shame
    ...
    show m_shame
    show m_m_normal
    p "P-please...f-fuck me...I'm at my limit..."
    scene temple
    show m
    show m_cockdown
    show m_shame
    ...
    show m_shame
    show m_m_normal
    p "Ahh...[d]..This position...Ngh...Too deep..."
    scene temple
    show m
    show m_cockdown
    show m_shame
    ...
    show m_shame
    show m_m_normal
    p "Ahhh...please slow down [d]...ahhh..."
    ...
    show m_m_normal
    p "Ahh..ahh...[d]"
    "It was the longest intercouse [p] has. Normally, [d] doesn't hold back as much and he stops as soon as [p] cannot take it anymore."
    "They lie on the ground."
    d "You cum a lot [p]. Are you still awake?"
    scene temple
    show m
    show m_cockdown
    show m_shame
    ...
    show m_shame
    show m_m_normal
    p "I said I'll stay with you on my own free will. I cannot escape from you anyway."
    d "..."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "But go together with me, to the human world. This forest and you are consuming me. At least, I want to escape one."
    d "..."
    "[d] stays silents."
    scene temple
    show m
    ...
    show m_m_normal
    p "..."
    d "It is not safe right now. Something big will happen in the human world, sooner or later."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "What do you mean?"
    d "When entered you to temporary cut the connection with the Light Field, I saw utter chaos. Humans playing God, manipulate energy from that field while the real Demi God was nowhere to be found."
    d "With God's code inside and his sense of respinsibility, there was no way this can be happening, unless..."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "Do you think he was killed?"
    d "..."
    d "It seems that way." 
    scene temple
    show m
    ...
    show m_m_normal
    p "..."
    d "A Demi God might get killed by other creatures. Are you happy to know that?"
    scene temple
    show m
    show m_cockdown
    show m_shame
    ...
    show m_m_normal
    p "I-..."
    "[p] turns back and sees [d] is gazing at him."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "..."
    "Unable to speak, he hugs [d] tight." 
    "Everytime [d] looks at him like that, his will becomes weaker and he feels unease."
    d "Is it that cold?"
    scene temple
    show m
    show m_cockdown
    ...
    show m_m_normal
    p "..."
    "[p] didn't reply. [d] strokes [p]'s head and kisses his forehead."
    d "I risked my life and lost a lot of my power saving you knowing this and how hateful you are toward me. If I die, so it is, but don't show me how happy you are if that time comes."
    d "Smile, laugh, happy, joyful. At least, do it after I'm dead."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "..."
    "[p]'s voice shakes as he closes his eyes. He unconsiously grasps [d]'s back harder."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "I-I'm sleepy.."
    "It is not only human world, [p]'s mind was in chaos too."
    "He cannot separate left and right, right and wrong anymore."
    "Is it because he was isolated with [d] and had to depend on [d] to survive for too long that he totally lost it? Or is it because [d] gives him that care and love he had always longed for but unable to get?"
    "Before, his anxiety level became high each time he saw [d]. But lately, just seeing [d] gives him an extreme calmness that he hasn't have for a long time." 
    "Everytimes [d] touches him, he feels overwhelm by an unknow feeling and his heart pounds heavily as if he was sick."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "..."
    "[p] askes [d] with a hesitate voice."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "If you think that is what I'll do, why are you keep on doing this? Isn't it better just let me die?"
    ...
    show m_m_normal
    p "..."
    d "I rather let you hate me than watch you go away, far from me."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "..."
    "[p] looks down to move his eyes away from [d]."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "If one day, you was really going to die, and I did it, will you regret?"
    "To [p] suprised, [d] gently caresses his head."
    d "I won't regret. If that is how much you hate me, so it is."
    scene temple
    show m
    show m_cockdown
    show m_shame
    show m_m_normal
    p "..."
    d "I'll be sad and angry for the thing you did, but my feeling for you won't change. As I leave this world, the last emotion I have will be the worried feeling for you."
    "[d] hugs [p] tighter."
    d "I love you [p]."
    scene temple
    show m
    ...
    "Time passes. [d] looks at the sky and finally breaks the silent."
    d "[p], if you are still awake, today is a starry night."
    scene temple
    show m
    show m_cockdown
    show m_shame
