...
label control4_ques:
    ...
    d "No wonder people said you are blood-thrist. That fighting style suits your strengths and weaknesses." 
    ...
    d "With that many enemies and this type of body plus your reflection speed, do you really think you can be alive after disowned? It feels like your father send you to your own grave huh?"
    ...
    p "Uhm..N!"
    "[d] smirks"
    d "Do you know what you look like? A stepping stone for your brother. Maybe your father already plan it from the start. Hmph, that explains why he didn't pay much time for you, he had to guide the future king." 
    ...
    p "(Is this the way it ends now? My little dream of the three of us having good times like we used to be...My little dream of having someone by my side, love me, and accept me...)"
    ...
    d "Loosen up!"
    p "(Is he really turn a part of my brain into stone?...Will I really become submissive to everyone like a pitiful human pet? Does my mind still work that time?)"
    "[p] tries to soften himself. The thurst becomes faster and stronger in disregard of [p]'s pain. His muscle keeps on twitching."
    p "N...ahh...aaa..."
    d "Now nothing will in the way."
    ...
    p "Ngh...aaa...m..."
    "It was even more painful than all the tortures [p] had done. [p] feels like his body cannot take it anymore. Maybe it was the death that suits him best."
    d "N!"
    ...
    p "Ngh!"
    "[d] caress [p]'s head."
    d "It must have been horrible. But I cannot just let you die. I don't want to let you go."
    p "Ngh...[d]..."
    "[d] smiles."
    ...
    p "(I'm still alive?)"
    "[p] looks at his hands. He seems to have recovered. His head feels much lighter too, there was no stone in there anymore."
    p "..."
    d "You have waken up."
    p "!"
    p "[d]!"
...
label badend:
    ...
    "[p] laughs loudly as he saw how tense [d]'s face becomes. It was the first time he saw [d] like that. [d] quickly relaxes his face and smirks." with vpunch
    ...
    "[d] smirks. He kicks [p] to their way then crushes his stomach with his foot."
    p "Kuk!...Ngh..."
    ...
    p "[d]-[d]! Let's go!"
    "[d] rams [p]'s stomach harder, makes it more painful and difficult for him to move."
    p "Ugh!"
