...
label control4_ques:
    ...
    p "Haa...haa..."
    d "It breaks just with that strength. Your bones are not good for fighting. I can make you immorbilize with just one punch in the back."
    d "Each time you went to a battle field or a dangerous investigation, it must look like a life and death gamble. Yet, you willing to do it to prove your worth. Even if after that, all the assasination atempts follow." 
    d "I can understand why you become so furious when it was your brother who become the crown prince. It seems like your father turns you into a danger magnetic while keeping your brother safe." 
    p "S-STOP!!"
    "[p] escapes [d] and throws him a kick." with hpunch
    "[d] breaks [p]'s leg." with vpunch
    p "AAAAGGGGHHHH!"
    "[d] throws [p] to the ground" with hpunch
    d "Are you really his son? It looks like you just being used for a political purpose."
    ...
    "[d] touches [p]'s broken arm joint."
    p "Uhm..."
    ...
    p "I lied to myself. I didn't look for it for the throne. All I really want is just to turn back in time, to when nothing had turn out wrong between me and my family...I screw everything."
    "[p] sobs." 
    p "...I beg you [d]...I just want to have someone on my side."
    "[d] touches [p]'s face."
    d "What a shock. If it didn't come from your mouth, no one wouldn have believe it. Love, what a simple wish for the one who ruthlessly slaughter everyone oppose him."
    p "*sob...*sniff..."
    ...
    d "Accept your fate [p]. At least you have had your fun with me."
    ...
    p "Why do I have to endure your torture and humiliation before I die? Who give you the right to hurt me and trample on my sanity? Does God not need moral?"
    d "No." 
    d "But aren't you just doing the same? How many monsters and humans had you torture to death? Aren't they living being too? Aren't they worthy to be treated like one?"
    ...
    "He wish that he can become mindless like a doll. If he is, he will not feel any pain, and his heart won't be broken. He doesn't need happiness anymore. He just doesn't want any more misery." 
    ...
    "[p] tries to soften himself. The thurst becomes faster and stronger disregard of [p]'s pain. His muscle keeps on twitching."
    p "N...ahh...aaa..."
    ...
    p "Ngh...aaa...m..."
    d "N!"
    "[p] becomes unconscious and falls on his lap."
    d "[p], [p]!"
    d "(He's fine.)"
    p "Ngh!"
    "[d] caress [p]'s head."
    ...
    p "He alters me... All the rape, beating up, hypnotize, humiliation, all his craps about how I will die and cannot use The Stone, they are just for me to give up resistance."
    p "FUck! If I was in my right mind, I wouldn't have believe it. That feeling of near death must be his hypnotize. I'm so dump. If I fought back, I might be dead but it will at least gives him a fatal damage."
    "[p] heard hand claps."
