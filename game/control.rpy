...
label control4_ques:
    ...
    "[d] easily avoid [p]'s attack just by a small and swift movement. He smirks at [p]."
    p "!"
    ...
    p "S-STOP! JUST SHUT UP!!! What do you even know?!? How else can we defeat them?!! SHUT THE FUCK UP!!"
    ...
    p "N-no...He...n..would never allow anyone to cross the line...h...He doesn't know anything..."
    d "You like to call your brother his puppet, because your brother listen to him. But you look more like his puppet to me. The rumors spread everywhere. Don't tell me he doesn't know."
    p "P-please stop..."
    d "He should have ask you something about those rumors. Either he already know and still push you off the cliff, or you just mean nothing to him."
    p "S-stop..."
    "[d]'s words confused [p]."
    d "He might have know it too. You were an abnormal. A creature that can go against The Flow and unable to in sync with this world. An ill-fated human."
