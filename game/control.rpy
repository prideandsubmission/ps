...
label control4_ques:
    ...
    "[d] caress [p]'s butt then lift [p]'s hip up."
    p "N-no [d]."
    p "!"
    "[d] brutally rams his cock in." with hpunch
    p "Mgh..."
    ...
    p "AGHHH! AAAAGGGGHHH!"
    d "Hahaha, you seems to have waken up. Look at yourself. Is it that hard to control your own urine? I can see some stool too. Have you devolve to become an animal now?"
    scene darkforest
    p "...W-Why..?"
    "[p] was paralized. He feels so ashamed for the little feeling and trust he have for [d]. To [d], he was merely an object for entertainment, no more than a toy he plays to pass time."
    ...
    p "..."
    d "But that's ok. I just need to break you harder to turn the center part of your brain into stone. Your connection with human oneness will be cut. You will not able to resist anymore."
...
label badend:
    ...
    p "..."
    "Love or hate, being adored or abandoned, they have gone from his life forever. Even if he escapes, he cannot looks them in the eyes again. Now, there is only him and this crazy monster..."
    ...
    p "No, please [d]. I was naked and humiliated in front of my own family and everyone here. Isn't it enough? I have lost everything. Please give me some mercy."
    d "As soon as you were about to break, I let you rest. The result? You just hate me more and bite me harder."
    d "You can only blame yourself for barking and scratching your master. What did I told you? This time I won't stop until you completely break and only had me to hold onto."
    ...
    p "U-uhm...n..."
    scene castle_poop
    "After being fucked by the snakes for a long period of time and the emotional damage [d] causes, [p] nervous system just beak down. Unable to control his body's fluid, [p] shits himself."
    p "Ngm!"
    ...
    "Their faces become furious when they saw [p]."
...
label goodend:
    ...
    p "K-kiss."
    d "..."
    "[d] releases [p]. He sits on the ground, holds his knees."
    p "He is just an innocent soul, like my brother. But I almost kill him for the stone while he had always been nice to me." 
    p "I have...always been that way. I hurt and kill who care and nice to me. I'm just a horrible bastard chasing after fame and power."
    "[d] sits down and gently touches [p]'s head."
    d "I know you will not do it."
    "[p] looks at [d]."
    p "What do you even know?"
    d "I know underneath that cruel and ruthless mask of yours is a very empathic and vulnerable soul."
    p "..."
    "[p] cries. He doesn't know if [d]'s words are true or not, but it hurts him to the bones."
    d "..."
    ...
    "He softly shoves [d] away. [d] releases his grip. The two of them become motionless for a brief second." 
    ...
    "He thought [d] wouldn't know, but he caught his gaze. Suprised, [p] looks at his eyes for a brief moment then looks away." 
    d "..."
    p "..."
    ...
    "[d]'s words embarrassed [p]."
    p "..."
    d "Your endorphins levels went high because of our intense fight just now. It increases your sex drive. This is just human's nature. Not like it was because of me, so don't need to be ashamed."
    p "..."
    p "!"
    "[d] jerks [p]'s cock."
    ...
    p "What do you mean?"
    d "When entered you to cut the connection with the Light Field, I saw utter chaos. Humans playing God, manipulate energy from that field while the real Demi God was nowhere to be found."
    d "With God's code inside him, there was no way this can be happening, unless..."
    p "Do you think he was killed?"
    d "..."
    d "Maybe. Are you happy to know that Demi Gods can die?"
    p "..."
    d "You sure are, huh?"
    p "I-..."
    "[p] turns back and looks at [d], who is gazing at him."
    p "..."
    "He doesn't say anything anymore but hugs [d] tight." 
    "Everytime [d] looks at him like this, his will becomes weaker and he feels unease."
    d "Is it that cold?"
    p "..."
    "[p] didn't reply. [d] strokes [p]'s head and kisses his forehead."
    d "I risked my life and lost a lot of my power saving you know this and how hateful you are toward me. If I die, so it is, but don't show me how happy you are if that time comes."
    d "Smile, laugh, happy, joyful. At least, do it after I die."
    p "..."
    "[p]'s voice shakes as he closes his eyes. He grasps [d]'s back harder."
    p "I-I'm sleepy.."
    ...
    "Everytimes [d] touches him, he feels overwhelm by an unknow feeling and his heart pounds heavily."
    p "..."
    "[p] askes [d] with a hesitate voice."
    p "If you think that is what I'll do, why are you keep on doing this?"
    d "Because if I let you go, you will go for sure. I rather have you hate me and stay with you."
    p "..."
    "[p] looks down to move his eyes away from [d]."
    p "If one day, you was really going to die, and I did it, will you regret?"
    "To [p] suprrised, [d] gently touches his face."
    d "I will not. I'll be sad and angry for the thing you did, but my feeling for you won't change. As I leave this world, the last emotion I have will be the worried feeling for you."
    "[d] then hugs [p] tighter."
    d "I love you [p]."
    p "..."
    p "(It's warm...)"
    p "..."
    "It feels like the time had stopped. [d] doesn't know what to say, and [p] doesn't speak. [d] finally break the silent."
