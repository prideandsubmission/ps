...
label control4_ques:
    ...
    p "..."
    p "I lost the bet. Will you fuck me now? Make me your bitch? Force me to suck your cock? Drink you pee? Create a new kind of torment?"
    d "What do you think?"
...
label badend:
    ...
    "[d] laughs. He grasps [p]'s chest, where his heart is. He graps so tight that [p]'s chest bleed."
    p "Ugh!"
    d "Don't ever think of dying. I gave you a bless, to save your pitiful ass. But if these power were to taken away, you still won't die."
    d "Because you are not a human anymore, but a half-God half-monster trash. Having none of my power here just means you can't move and can't die."
    p "..."
    "[d] kicks [p] to the ground" with hpunch
    p "Mgh!"
    d "What should I do with you now, to make you happy? Ah, how about reunite with your family?"
    p "Don't you dare-"
