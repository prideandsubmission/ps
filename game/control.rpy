...
label goodend:
    ...
    "[p] looks away."
    p "..."
    "[d] releases [p]. [p] sits on the ground, holding his knees."
    p "Just a little more and I had got it...What an idiot."
    "[p] holds his face and cover his eyes with 2 hands for a while. He then glances at [d]."
    ...
    p "!"
    p "..."
    "[p] gives [d] a weak response. He numbles in a small voice."
    p "You're wrong..."
    "[p] tucks his head between his knees. [d]'s words hurt him to the bones."
    d "..."
