...
label badend:
    ...
    "[p] licks and eat it"
    d "Feel free to give him some comments. I'm not going to do anything to all of you. He is the main character after all"
    h "S-Suit yourself"
    h "What a disgrace!"
    h "Go die somewhere else! Don't bring troubles here"
    h "Slut!"
    h "How can you live like that? Kill yourself and save us some troubles"
    p "..."
    d "Dirty. Clean him up"
    "[p] pee and ass hole was fill again"
    p "Mgh! Ngh!"
    "[d] put his legs on [p]'s back"
    d "Clean it all up [p]. Someone bring me a cup of tea"
    h "Y-Yes sir"
    k "..."
    p "[d], please ..."
    "[d] touches [p]'s face"
    d "I didn't hurt any of them"
    p "Please return to the forest..I'm sorry. I'm really sorry"
    d "Aren't your skin seems thinner than usual?"
    p "I beg you [d]"
    "[d] points to a person"
    d "Come here"
    h "Y-Yes sir"
    d "Prepare for me .."
    h "Yes sir"
    "The servants comeback with a dog chain, a marker and lots of flag." 
    "The words written there is \"Prince [p] - Monster's whore\", \"Fuck me! Free\", \"Worthless Prince\", \"The throne is mine\" "
    "[d] writes some word on [p]'s back: owned, cock slave, whore"
    d "When we finished walking around the casle, we can go back. What do you think"
    p "..Mgn...ahh...Y-yes master...ahhh..."
    d "Can you crawl like that?"
    p "...N...ahhh...y-yes...ahh...I c-...hgh..ahhh"
    d "Let's go meet everyone first"
    "The come to the balcony"
    h "The King had something to say! The King had something to say!"
    "The citizens go out of their house and gathered around the bacony. A magic stone refresh the scene to the sky"
    d "Citizen of [ri], I am not the king but he had gives me the right to speak to you. Let me introduce you, the first prince"
    "All eyes looks at [p], who is on four and got penetrade rapidly in pee and ass hole"
    p "Ahh...haa...mgh..."
    d "As you can see, he had a tremendous talent. Today, I want you to all meet him and gives him some affections." 
    d "As the future king, he needs the truth to become a better ruler. So you don't need to go easy on him. He will serve you with all his heart"
    p "..."
    d "Something leaking. Prince, you cannot control your urine again. How many times have it been?"
    p "Ugh...m...I-..Ugh...I'm s-sorry...ahhh..."
    "[d] gives a servant the lease and retrieve the insects."
    d "Let them do whatever they want. "
    p "..."
    d "Go on and have fun without me, future king"
    p "No, [d], please"
    "The servant holds the lease forward."
    h "Move fast, future dog"
    h "Whenever he stops or not move ahead of me, whip him, beat him. Got it?"
    h "Yes sir"
    "5 hours lateer"
    h "The prince had come back"
    d "..."
    "The servant had to hold [p] and pushed him in. [p] was in a critical condition. He was beaten from head to toe. Blood and sperm everywhere. His hands and legs was chopped off, his tongue is not there anymore. His eyes were taken away using a clean and neat technique"
    ...
    p "M...my fa-..."
    d "I don't get what you are saying, and it seems like you cam't write either"
    d "Oh, did you mean your family, are they here?"
    "[p] nods"
    d "Yes, they are here, they are watching you right now"
    p "..."
    d "Just kidding, I already send them to their room. But someone will told them soon"
    p "K-ki-..."
    d "Someone put something in this mouth. It hurts my brain. If they cut the tongue, cut all the way. Seems like he can still perform half-ass talk"
    p "..."
    d "Oh yeah, the insects miss you"
    "The insects jump back and host [p]'s body"
    p "Uhm..h-"
    "A servant puts his socks into [p]'s mouth"
    d "Throw him into a dog cage!"
    "At night, [p] cries. He knows that his hands and legs can regenerate if he did right. But what about his eyes and tongue."
    "Even if they don't like him, how could the citizens do that to him. He stops himself from thinking further. The one who did all this to him must be thugs and illegal drug dealers"
    p "Hmp...ahh...mmm..."
    d "Dwell in pleasure all the time. What a good life"
    "This is the second time [d] comes to [p] at night, beside the first time they meet."
    "[d] opens the cage and bring [p] out"
    p "Hmp..."
    "The insects minimize themself and went to [d]'s item holder"
    "[p] feels an energy pass through him. [p] opens his eyes. His arms and legs return to normal"
    p "..."
    "[p] kneels and bow"
    p "[d]. I'm really sorry. Please leave right tonight. I'm sorry for talking back at you"
    d "We haven't done yet"
    p "How long do you plan to stay here?"
    d "At least 3 months. A day had pass.You can start counting now"
    p "No, please [d]. I cannot take it. I can't"
    d "If you are this weak, you shouldn't have challenge me"
    p "What can I do fo-"
    d "Nothing"
    "After one month of constant abused publicly in front of his family and people, [p] had become more docile. [d] finds it's no use to stay longer so they went back to the forest"
    "Since then, [p] had become more timid, more aware of the way he talks to [d] and become more dependent on [d]'s experssion. [d] really please about it."
    "Sometimes, [p] release some angry experssions or talking back, or refuse to follow [d] sexual demand. [d] reminds him of going to the castle again and [p] begs [d] to forgive him"
    "There was a time he went as far as kiss, give [d] a blowjob or his asshole just for [d] to forget about it"
    "End"
