...
label control3:
    ...
    p "..."
    "[p] doesn't know if he still have an ego. Even his self estem had dropped to the point of no return after days and days of constant abuse and humiliation. Don't let [d] angry is his only motive now."
    "Sometimes he wonder if this is all a dream. He wish when he opens his eyes, everything returns to normal. At this point, the throne, his status, none of it matter anymore."
    "He angry, but now, he doesn't dare to glance at [d]."
    p "(If this keeps on, I'll go insane.)"
    p "(Should I just kill myself and and this pain?...No, I don't want my life be over just like this.)"
    d "Why are you looking away while I was talking? Do you understand even a word I just said?"
    p "..."
    "[p] looks at the monster."
    p "...[d]. You said I have realize my position."
    ...
    d "Good. Remember to suck my cock like that."
    scene darkforest
    ...
    p "!"
    p "...."
    "He pushes [p] to the ground"
    scene deepimpact_head
    "[d] grasps [p]'s legs and start to put his dick in." 
    p "Mgh!"
    p "Please [d], not no-...Agh!"
    d "Take a look at your face. You don't sound congruent"
    p "Ahhh...Ahhh..."
    "[p] doesn't want it. But he know it'll be better if he lets the monster slams his dick in."
    p "..M...ngh..."
    ...
    "[p] cries. It's normal for him to burst his tears while having sex with [d] because it hurts a lot. However, right now, there is no pain. What makes [p] cries is himself."
    ...
    d "You are too cute. It makes me want to become one with you forever."
    p "...Mgh...h..N-no!...Stop......m..."
    d "You won't be satisfy if I end like this. Suck a faker. We have intercouse dozens of times already. I know how to make your hole twitch in happiness."
    p "N-no... Please [d], let me go. I beg y-"
    scene deepimpact_deepcum
    p "AGH!..."
    p "Ngh! P-please st-"
    scene deepimpact_deep
    p "N...mgh!...Take it out...please...You have cum alrea-...ahh"
    d "You must feel really good right now. I keep on hitting your sensitive spot."
    d "Even your ass hole have shaped itself to fit my cock. How can you live without me?"
    p "...ngh! Ahh..."
    p "...[d]...P-please stop..."
    ...
    p "P-Please let me go. Have some mercy."
    scene darkforest
    "[d] stops"
