...
label control4_ques:
    ...
    p "..."
    d "Hmph"
    "[d] brutaly slaps [p]. [p] flies to the left, hit a tree and falls to the ground" with vpunch
    p "Ngh!" with vpunch
    "[d] stomps on his head" with hpunch
    p "Hph!"
    d "When have you become to sleep soundly like this. Should you be more aware of your surrounding?"
    p "W-Wha-"
    "[d] brutally stomps on [p]'s head again then lift his foot off" with vpunch
    p "M...Aa..."
    p "..."
    "[p] licks his foot"
    p "Mgh..."
    d "At least you still got manners"
    ...
    scene darkforest
    "[d] stomps on [p]'s stomach" with vpunch
    p "Mgh!"
    d "I own you. I can beat you for no reason whenever I want. Got it?"
    p "F-fu..."
    "[p] cries"
    d "Cries again? Had you become meek? Or are you about to become insane?"
    "[p] stands up, rushes to [d] but falls. He still paralyzed. [d] laughs." with vpunch
    d "Finished taking your shit first. Don't attack me while poping"
    p "F-Fuck you! I'm not!"
    "[p] punches [d] in the face repeatedly. He didn't avoid." with hpunch
    d "..."
    ...
    p "HAAAAAHHHHH!!"
    "[p] punches [d] stronger and faster." with hpunch
    d "When we first met, I didn't pay attention. But is this really how you always fight? Your reflection is subpar. You cannot react quickly enough."
    d "No wonder people said you are brutal. You were not strong enough to spare the enermies. One suprise attack from the back and you are gone."
    p "SHUT UP!?!"
    "[d] catches the punch and breaks his arm" with vpunch
    p "AGGHHHHHHH!"with hpunch
    p "Haa...haa..."
    d "It breaks just with that strength. Your bones is not strong enough to be a warrior. Let alone killing monsters." 
    p "S-STOP!!"
    ...
    d "How can you supass The Flow thresold is beyong my understading. It's a miracle that you reached this level. But this is your limit."
    ...
    p "Ha..haa... So you want to kill me yourself instead?"
    d "..."
    p "Haaa...ha...ugh...haaa..."
    p "Haa...I need the stone... Even if it is true...The Stone will... haa..haaa..."
    "[d] laughs"
    ...
    d "The moment you touch The Stone, either it or you will be destroyed."
    p "You are lying."
    "[d] smiles"
    ...
    d "You are not lose to a mere monster, [p]. You lost to a demi God."
    p "God, Demi God my ass. Even if you all hated me, am I not a living being? Why did you have to trample on me like this? Is it a payback for what I did to you?"
    d "That's all what you remember huh? The things I remember about that night was very different."
    p "If there's any mercy left in you. Do it quick and clean, without saying a single word."
    ...
    p "..."
    p "I lost the bet. Will you fuck me now? Force me to suck your cock? Drink you pee? Create a new kind of torment?"
    d "What do you think?"
...
label badend:
    ...
    "[p] smirks and turns away. He looks like an empty shell."
    "[d] grasps [p]'s chest, where his heart is. He graps so tight that [p]'s chest bleed."
    p "Ugh!"
    d "Listen and remember this well. I gave you a bless, to save your pitiful ass. But if these power were to taken away, you still won't die."
    d "You are not a human anymore. Having none of my power here just means you can't move and can't die. So don't try."
    p "Ha...hahaha. What a useless thing to do. You've gained nothing from me but curses. I, in the other hand, can sense that your power is decreasing. And it seems like it won't come back."
    d "..."
    ...
    k "I-I uderstand."
    k "..."
    k "Please...at least give him some cloth..."
    ...
    p "..."
    d "You don't look too happy [p]. How about visiting the citizens. Let see how the citizens of this fallen country will welcome their betrayal prince."
    "[p] was in shocked. He shuts in his mind"
    ...
    p "Ugh!"
    h "I said move! Did you still think you are still our prince after all this? You are nothing but trouble since the day you are born."
    p "U-uhm...n..."
    scene castle_poop
    "[p] shits himself"
    p "Ngm!"
    ...
    d "So you have been holding it this hold time huh?"
    "[p] clenches his whole body. He afraid [d] will hit him."
    "[d] uses his power to hide the stool to the ground and throws [p] to a dog bath."
    p "Ngh"
    "[d] slashes water from the water basket to [p]'s ass."
    p "Ngh! U..."
    "[d] wipes his ass."
    p "U-a...ngh!"
    d "Embrassing?"
    "[p] nodes"
    "[d] puts his finger into [p]'s asshole."
    p "Ngh! N..."
