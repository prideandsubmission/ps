...
label badend:
    ...
    p "Mgh! Ngh!"
    "[p] was there, surounded and penetrated by many venomous snakes."
    ren "Borther!"
    h "Prince [p]!"
    "[p] reacts. The snakes bite him."
    p "UUHHMMMM...UHMMMM..."
    p "Uhmm...uhmp..."
    ren "No. Please stop it! He will die!"
    "[k] holds [ren] back."
    k "Look, there's a lot of old bites. If those vemon could kill him, he would have die long ago."
    p "Um...N..."
    d "You are right. He is now a mixture of human and a more powerful being. These mere poison cannot kill him. It just causes him serve pain and pleasure"
    "[d] kicks the cat. It turned upside down and [p] falls to the ground" with vpunch
    p "Uhh...ahhh..."
    "The snakes get out of [p]. They have had satisfy by releasing their poision, sucking his blood and energy. They come back to the ground."
    show present_push
    ...
    p "Uhm..."
    "[p] sucks [d]'s finger."
    d "Yes, suck it passionately like that."
    "Unable to witness this scene, [ren] falls on his knees and hands. He looks at the ground instead of the scene in front of him."
    ren "What have you done for him to become like this? The brother I know submit to no one...He will fight to death to kill you."
    "[d] smirks."
    d "He tries. But it didn't work out well, right [p]?"
    "[p] stays silent."
    k "..."
    ...
    d "Isn't that too rash? This might be your last conversation together."
    ...
    "[p] frighten."
    p "No!...N-no...[d]...Please...chase them out..."
    p "..."
    ...
    k "No! please don't. Monsters of the Dark Forest like you never interested in things like this to begin with. Please don't invole the citizens to your play."
    d "If you do it well, no one will suffer greatly. Else, you will understand what is a country covers by blood means."
    k "..."
    k "I uderstand."
    "[k] looks at [p]."
    d "What's with that look? Do you want to beg me not to hurt him?"
    k "It won't change your decision."
    "[d] laughs."
    "The king told the mages to prepare the magical sky screen for the announcement. He has a conversation with [ren]. This is the first time he saw [ren] and the king in an argument."
    ...
    p "!"
    p "No, please [d]. Let my family and all people in the capital see me like this. Isn't it enough? If you push more, I'll go insanse."
    ...
    d "You can only blame yourself for barking the master. I won't stop until you completely break and hold onto me."
