...
label control4_ques:
    ...
    "He asks himself if this is his karma."
    ...
    p "Ngh!"
    "[d] caress [p]'s head."
    d "You look so sorrowful and confuses when I first meet you. Now you look even more so. You must have loathe me with everything you have." 
    d "But I ..."
    ...
    p "FUck! If I was in my right mind, I wouldn't have believe it. If I fight back that time, I might be dead but it will at least gives him a fatal damage."
    "[p] heard hand claps."
    ...
    d "The only drawback is your arms and legs are attached to the Earth. But it's a cheap price right? Beside, your 2 slutty holes is till easily accessible, perfect for a piece of meat."
    p "[d]! YOU BASTARD!"
