...
label goodend:
    ...
    p "K-kiss."
    d "..."
    "[d] releases [p]. He sits on the ground, holds his head."
    ...
    "[d] sits down and gently pats [p]'s head."
    ...
    p "..."
    "[p] cries." 
    "He doesn't know if [d]'s words are true or not, but it hurts him to the bones."
    p "..."
    d "..."
    ...
    "[d] kisses [p]'s forehead and pushes him into his chest."
    d "I'll be waiting."
    p "..."
    "That's unpleasant feeling re-appear again. [p] feels like his body is burning. It makes [p] feels unwell."
    "He softly shoves [d] away. [d] releases his grip. The two of them beging motionless for a brief second." 
    ...
    "After pausing for a moment, [p] glances at [d]."
    ...
    "Suprised, four eyes look at each other for a few second then [p] looks away."
    p "..."
    ...
    p "..."
    d "Your endorphins levels went high because of our intense fight just now. It increases your sex drive. This is just human's nature."
    p "..."
    p "!"
    "[d] jerks [p]'s cock."
    d "If you don't want to have sex with me, I'll help you release."
    p "Aaa...Hmp..."
    "[p] cums."
    p "Ahh...um..."
    d "It stills hard."
    p "[d]...F-fuck me."
    d "Are you sure? Don't you hate me?"
    p "P-please fuck me [d]!"
    p "!"
    ...
    d "?"
    p "I said I'll stay with you on my own free will."
    d "..."
    p "Go together with me to the human world [d]. This forest and you are consuming me. At least, I want to escape one."
    d "..."
    "[d] stays silents."
    p "..."
    d "It is not safe right now. Something big will happen in the human world, sooner or later."
    p "What do you mean?"
    d "When entered you to cut the connection with the Light Field, I saw an utter chaos. Humans playing God, manipulate energy from that field while the real Demi God was nowhere to be found."
    ...
    d "..."
    p "..."
    "He doesn't answer but hugs [d] tight."
    d "Is it cold?"
    p "..."
    "[p] didn't reply. [d] strokes [p]'s head and kisses his forehead."
    d "I risked my life and lost a lot of my power saving you knowing this. If I die, so it is, but nothing sader than to see you laugh as I die..."
    d "I love you [p]. I love you a lot."
    p "..."
    "[p]'s voice shakes as he closes his eyes."
    p "I-I'm sleepy."
    "It is not only human world, [p]'s mind was in chaos too. He cannot seperate love and hate."
    "[d] rapes him, humiliates him, beats him into submission. [d] acts like it was normal to do dominate him like that while it causes [p] huge pains, physically and emotionaly. He hated [d] to the bones." 
    "But in the other hand, he puts his life at risk to save him. He gives him the care and love he had always long for."
    "If he was a normal human, with just the way he looks at [p], [p] might have liked him. They would have been good friends."
    "[p] remmbered a friend like that, who he killed. If [d] was like that, maybe nothing good will come out of it too. He just gives bad luck and destruction for everyone around him with his cruel decisions."
    "He had always asked himself if one day, he too, can have love. Can his little wish of having someone by his side be fullfill."
    "[p] hesitates, he askes with a small voice."
    p "What is it about me that you love?"
    "[d] smiles. He kisses [p]'s head."
    d "Everything."
    "[p] smirks."
    p "Everything huh? If one day I kill you with the power you gave, and happily laugh as you die, will you hate me?"
    "To [p] suprrised, [d] looks calm."
    d "I'll be deeply sad and angry, but I will never hate you. As I leave this world, the last emotion I have will be the worried feeling for you."
    p "..."
    "As [d] hugs him tighter, a tiny tear falls from [p]'s eyes."
    p "(It's warm...)"
    "[d] caress [p]'s head and look at the sky."
    d "..."
    d "[p], if you are interested, today is a starry night."
    p "..."
