...
label control3:
    ...
    d "3 feets."
    p "?"
    d "That tree is the pivot point. From there, you can freely move around 3 feet."
    ...
    "[p] shocked. hugs his knees. His head tucks between them."
...
label control4_ques:
    ...
    p "SHUT UP!!"
    "[d] easily avoid [p]'s attack just by a small and swift movement. He touches [p]'s face and lips."
    p "!"
    "[p] steps back then jump backward."
    p "(Crazy bastard! He's not serious at all. )"
    d "No wonder people said you are blood-thrist. Not only your reflexness is subpar, your moves are too predictable." 
    d "Slaughter all enemies as fast as possible is the only way you can win and survive." 
    p "!"
    ...
    d "It must be normal when you are born. But the more you grow up, the more you train and improve, the more the world turns its back on you. Even those who close turn their backs on you."
    ...
    "[p] glance at [d]."
    d "..."
    p "Haa...ugh! S-shit! No. Not like this. I need The Stone...I will... hmp..."
    "[p]'s glance become softer."
    p "I beg you [d]. Give me a chance. I don't need anything."
    p "I lied to myself. I didn't look for it for the throne. All I really want is just to turn back in time, to when nothing hadn turn out wrong between me and my father..."
    "[p] sobs." 
    p "You can laugh at me all you want...I beg you..."
    "[d] touches [p]'s face."
    d "What a shock. If it didn't come from your mouth, I wouldn't have believe it. No one will. Relationship, what a simple wish for the one who ruthlessly slaughter everyone oppose him."
    p "*sob..."
    "[p] tries to hold his tears in."
    ...
    d "The moment you touch The Stone, either it or you will be destroyed. You are clutching at a straw [p]. There's no return for you. What's ruin is already ruin."
    p "No. You are lying..."
    "[d] smiles"
    d "I said that to you as one of the three oldest creation of God that is born to project The Flow and The First Stone so that this world will keep on living"
    "[p] clenches his teeth."
    p "Even if this world is pushing me away, am I not a living being? Am I not worthy to be treated like one? If you and it hate me, just kill me. it had been nothing but an endless pain." 
    p "Why do I have to endure it? Who give you the right to hurt me and trample on my sanity like this? Does God not need moral? Does God not need to be merciful?"
    d "No." 
    p "..."
    p "Hahaha...If God is like that, who can I even pray to?..."
    "[p] laughs while sobing."
    d "Aren't you just doing the same? How many monsters and humans had you torture to death? Aren't they living being too? Aren't they worthy to be treated like one?"
    "[p] was shocked. He had never think about that. After been through too much wars and saw what they did to others, [p] makes a habit of torture them in return." 
    ...
    "He ask himself if this is his karma."

    "[p] turns his head away. [d] grasps his face and turns it back."
    d "Look at me [p]!"
    p "..."
    "[d]'s eyes turn red. Again, [p] feels like his head was penetrated. But at this point, [p] does not care anymore. [d] can does whatever he wants to him."
    "He wish that he can become mindless. If he is, he will not feel any pain, and his heart won't be broken. He doesn't need happiness anymore. He just doesn't want any more misery." 
    "[d] thrusts his hand into [p]'s head, then his brain."
    p "Ughh...aaa..."
    ...
    p "Mmm...mngh...m..."
    "[p] cock hard on its own and cum. How much [d] want to torture and humiliate him before killing him off?"
    ...
    "The thurst becomes faster and stronger disregard of [p]'s pain. His muscle keeps on twitching."
    p "N...ahh...aaa..."
    ...
    d "(He's fine.)"
    p "Ngh!"
    "[d] caress it [p]'s head."
    d "You look so sorrowful and confuse when I first meet you. Now you look even more so. You must have loathe me alot." 
    d "But I ..."
    ...
    p "He alters me... All the rape, beating up, hypnotize, humiliation, all his craps about how I cannot use The Stone, they are just for me to give up resistance and accept the alteration."
    p "FUck! If I was in my right mind, I wouldn't have believe it. If I fight back that time, I might be dead but it will gives him a fatal damage."
    p "Now I'm done. I can't even move. What else does he want from me?"
    "[p] heard hand claps."
    ...
    "[d] smirks."
    d "You have become an immortal, just like me."
    p "!"
    d "You are no longer disrubt The Flow of this Earth. It won't push you away."
    p "What the hell are you saying?"
    d "The only drawback is your arms and legs are attached to the Earth. But it's a cheap price right? Beside, your 2 slutty holes is till easily accessible, perfect for a sex meat."
    p "[d]! YOU BASTARD!"
    "The ground is moving faster and faster, [p]'s arms and legs cracks. He consumes the Earth. His arms and legs recovered."
    d "Not bad."
    "[p] thurst to [d], about to attack him. [d] calls hundreds of spikes formed from the ground and shoot at [p] while [p] copy his moves." 
    ...
    "He looks at himself in the river."
    p "That fucker, why did he hate me so much. This body is so disgusting." 
    p "I should have killed myself the moment he captured me. Why do I rather live like this than die?"
    "[p] doesn't know which word of the monster is true. Should he try to get out of this forest, or to find the stone?"
    p "Even if I can get out, he will still find me. If he captured me again, I can no longer escape. He will force me to have sex with him again and again." 
    p "..."
...
label badend:
    ...
    ren "But dad!"
    "There are screams outside the door. [d] walks in with some monsters. They were carrying a cart with a big bag."
    ...
    k "!"
    ren "!"
    "[d] pull [p] out of the box." with hpunch
    p "Mgh! Ngh!"
    ...
    p "..."
    d "Huh?"
    p "D-dad. P-please don't chase me out. Please...accept me. I'm sorry for all the fighting and agruments. I never meant it."
    k "..."
    ...
    "The king drags [ren] out. He goes away without looking at [p]. He told the mages to prepare the magical sky screen for the announcement."
    "[p] looks at their blurry figure as they move futher and futher away."
    p "..."
    "[d] smirks."
    ...
    "[p] was shocked. Meeting them right now, as a betrayal, in this state, is what he doesn't want to face."
    ...
    p "Ugh!"
    h "I said move! Did you still think you are our prince after all this? You are nothing but troubles since the day you are born."
    p "U-uhm...n..."
    scene castle_poop
    "[p] shits himself"
    p "Ngm!"
