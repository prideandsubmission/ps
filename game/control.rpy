...
label goodend:
    ...
    "[d] touches [p]'s face and looks straight as him. [p] avoids it."
    d "I'll be waiting."
    p "..."
    p "D-don't touch me."
    ...
    "[p] looks away."
    "[d] moves closer and touches [p]'s face again."
    ...
    p "..."
    d "Your endorphins levels went high because of our intense fight just now. It increases your sex drive. This is just human's nature. Not like it was because of you. Don't need to be ashamed."
    p "..."
    p "!"
    "[d] jerks [p]'s cock."
    ...
    "Time passes. [d] looks at the sky and finally break the silent."
