...
label control4_ques:
    ...
    p "..."
    d "But that's ok. I just need to break you harder to turn the center part of your brain into stone before hypnotize. That'll stop all your resistances. You'll become submissive forever, not only to me but everyone."
...
label goodend:
    ...
    p "K-kiss."
    d "..."
    "[p] sits on the ground, holds his head."
    p "He is just an innocent soul, like my brother. But I almost kill him for the stone while he had always nice to me." 
    ...
    "[d] sits down and gently pat [p]'s head."
    d "I know you will not do it."
    "[p] looks at [d]. There was a few tears in his eyes."
    p "What do you even know?"
    d "I know underneath that cruel and ruthless mask is a very empathic and vulnerable soul..."
    p "..."
    "[p] cries." 
    ...
    "He softly shoves [d] away. [d] release his grip. The two of them beging motionless for a brief second." 
    ...
    p "..."
    "[p] looks uncomfortable. He sweats, his muscle becomes tenses and his heart races faster, his cock becomes stiff."
    ...
    d "..."
    p "Go together with me to where I want [d]. I don't want to stay here anymore. This forest and you are consuming me. At least, I want to escape one."
    d "..."
    d "We can do that if you want to, but I have to return here once a while..."
    p "..."
    d "..."
    d "...What I really want from you is..."
    "[p] turns back and hug [d]."
    p "I'm going to sleep."
    d "We can start as soon as you want."
    p "..."
    p "I need clothes."
    d "I can give you some tomorrow."
    p "..."
    "[p] hugs [d] tighter."
    d "Is it cold?"
    p "..."
    ...
    "[d] smiles, he caress [p]'s head and look at the sky."
