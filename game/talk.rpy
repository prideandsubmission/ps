...
label talk7:
    ...
    if talk > 20:
        ...
        "[p] doesn't know what it is or why he comes like that, but he doesn't like it at all."
    else:
        "[p] stays silent."
    jump simbutton2
label talk8:
    ...
    d "What's wrong?"
    p "..."
    p "When I fight you, what do you think of my skill?"
    d "That's what you have been thinking about lately huh?"
    p "..."
    d "I have never fight with my equals. The rest are just like flies to me. Including you. I don't pay attention."
    p "..."
    p "Is that so..."
    d "I just remember you have good strength and agility."
    p "..."
    p "T-that's...thanks..."
    "[d] takes a closer look at [p]. It's not really a compliment to him but he seems embrassed about it."
    "His look just now was like a kid who rarely got praise or attention. No one was there to show him how to live. And he cannot figure it out himself."
    "That's explain the feeling he gives [d] when they met."
    ...
    "Maybe it was because [d] haven't done anything bad to him like he used to. [p] actually relief whenever he sees [d] when wake up."
    jump simbutton2
label talk9:
    d "How are you feeling?"
    p "I'm good."
    ...
    p "..."
    p "Friends..."
    p "I used to have one...If he is still alive, he must have hate me to the bone."
    ...
    p "There was no way I can wash my hands from blood..."
    p "I know my brother loves me, but I always envy him. He was nice and bright by nature. Everyone gather around him and he always got what I wants."
    p "It's not fair for him. But I cannot talk with him like when we were little. I wish to be as far away from him as possible..."
    p "!"
    "[p] was suprise. He doesn't understand why he told [d] about all of it."
    "Was he sill under hypnotize?"
    p "..."
    ...
    p "..."
    p "Y-yes."
    "[p] and [d] sleep together till the morning."
    jump simbutton2
