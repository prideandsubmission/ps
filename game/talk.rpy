...
label talk4:
    ...
    show m_m_open2
    p "Why do you care?"
    "[d] moves closer and touches [p]'s chest. Then moves to his nipples."
    scene sit_sad with None
    show m_hurt
    show m_cockdown
    show m_blush
    ...
    show m_shame
    show m_m_1
    "[d] continue to kiss [p]'s neck and play with his nipples. [p] swepted away by pleasure."
    scene sit_sad with None
    show m_close
    show m_cockup
    show m_blush
...
label talk8:
    ...
    "It must have been hard. Given the state of emotional unstable he is in. Under his arrogant and ruthless mask, he was easier to get into depression, nervousness, panic, and anger than anyone."
